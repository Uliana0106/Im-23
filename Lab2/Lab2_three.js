...
document.addEventListener("DOMContentLoaded", () => {
 ...
 async function startRotation() {
    ...
    // Load textures
    const saturnTexture = new THREE.TextureLoader().load('assets/images/saturn_texture.jpg');
    const ringTexture = new THREE.TextureLoader().load('assets/images/ring_texture.jpg');
